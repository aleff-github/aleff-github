...
- [Exfiltrate Process Info - Linux](https://hak5.org/blogs/payloads/exfiltrate-process-info-linux)
- [ProtonVPN config file](https://hak5.org/blogs/payloads/protonvpn-config-file)
- [Windows netstat to Discord Exfiltration](https://hak5.org/blogs/payloads/windows-netstat-to-discord-exfiltration)
- [Exfiltrate Email And Password By Phising](https://hak5.org/blogs/payloads/exfiltrate-email-and-password-by-phising)
- [Change Desktop Wallpaper](https://hak5.org/blogs/payloads/change-desktop-wallpaper)
- [Send Telegram Messages](https://hak5.org/blogs/payloads/send-telegram-messages)
- [WLAN Windows Passwords Discord Exfiltration](https://hak5.org/blogs/payloads/wlan-windows-passwords-discord-exfiltration)
- [Close All Applications](https://hak5.org/blogs/payloads/close-all-applications)
- [Exploiting An Executable File](https://hak5.org/blogs/payloads/exploiting-an-executable-file)
- [Exfiltrate Photos Through Shell - Linux](https://hak5.org/blogs/payloads/exfiltrate-photos-through-shell-linux)
- [Standard Phishing Campaign](https://hak5.org/blogs/payloads/standard-phishing-campaign)
- [Standard Phishing Payload Using kdialog - Linux](https://hak5.org/blogs/payloads/standard-phishing-payload-using-kdialog-linux)
- [Continuos Print In Terminal](https://hak5.org/blogs/payloads/continuos-print-in-terminal)
- [Send Email Through Thunderbird](https://hak5.org/blogs/payloads/send-email-through-thunderbird)
- [Full-Screen Banner Joke](https://hak5.org/blogs/payloads/full-screen-banner-joke)
- [Uninstall Signal](https://hak5.org/blogs/payloads/uninstall-signal)
- [Change Remote Git Link](https://hak5.org/blogs/payloads/change-remote-git-link)
- [Set An Arbitrary DNS (IPv4 version)](https://hak5.org/blogs/payloads/set-an-arbitrary-dns-ipv4-version)
- [Add An Excepiton To Avast Antivirus](https://hak5.org/blogs/payloads/add-an-excepiton-to-avast-antivirus)
- [Change The App That Will Be Runned](https://hak5.org/blogs/payloads/change-the-app-that-will-be-runned)
- [Edit The Default Real App With An Arbitrary](https://hak5.org/blogs/payloads/edit-the-default-real-app-with-an-arbitrary)
- [Make Windows performant (but ugly and boring)](https://hak5.org/blogs/payloads/make-windows-performant-but-ugly-and-boring)
- [Change Windows User Name](https://hak5.org/blogs/payloads/change-windows-user-name)
- [The Mouse Moves By Itself](https://hak5.org/blogs/payloads/the-mouse-moves-by-itself)
- [Change the password of the windows user](https://hak5.org/blogs/payloads/change-the-password-of-the-windows-user)
- [Starting a PowerShell with administrator permissions in Windows 10/11](https://hak5.org/blogs/payloads/starting-a-powershell-with-administrator-permissions-in-windows-10-11)
- [Export Firefox Cookies Database](https://hak5.org/blogs/payloads/export-firefox-cookies-database)
- [Exports all the links of the downloads](https://hak5.org/blogs/payloads/exports-all-the-links-of-the-downloads)
- [Stop A Single Process In Windows](https://hak5.org/blogs/payloads/stop-a-single-process-in-windows)
